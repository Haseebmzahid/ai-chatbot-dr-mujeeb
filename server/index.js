...
app.get("/api/health", (_req, res) => {
  ...
  res.json({
    status: startupValidation.ok && database.ready ? "ok" : "degraded",
    product: "Dr. Mujeeb Ur Rehman WhatsApp AI Appointment Chatbot",
...
app.use((err, _req, res, _next) => {
  ...
  const payload = {
    message: err.name === "ZodError" ? "Validation failed." : err.message || "Something went wrong."
  };
